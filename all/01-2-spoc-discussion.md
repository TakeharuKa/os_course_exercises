...
* "Operating system"这个单词起源于__"Input Output System"__。
* 在计算机系统中，控制和管理__进程__、有效地组织__应用软件__运行的系统软件称作__系统软件__。
...
运行稳定：对bug的容忍度非常低，同时应该满足很高的鲁棒性
占用资源少：不过分强占应用程序的运算资源、存储空间
提供接口：能够为其上运行的应用软件提供接口调用硬件设备


- 为什么现在的操作系统基本上用C语言来实现？为什么没有人用python，java来实现操作系统？
因为操作系统对于效率的要求极高，C语言编写的程序执行效率高于python和java。
